    ...
    <main className="min-h-screen bg-slate-50 relative overflow-hidden font-sans selection:bg-blue-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <PlantCard title="Tanamannya Diva" value={sensors.s1} index={1} />
          <PlantCard title="Tanamannya Iqbal" value={sensors.s2} index={2} />
          <PlantCard title="Tanamannya Salma" value={sensors.s3} index={3} />
        </div>
      </div>
    </main>
  );
